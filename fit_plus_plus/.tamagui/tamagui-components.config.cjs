...
var require_Adapt = __commonJS({
  "node_modules/@tamagui/adapt/dist/cjs/Adapt.js"(exports, module2) {
    ...
    var Adapt2 = (0, import_core22.withStaticProperties)(
      /* @__PURE__ */ __name(function Adapt22({ platform: platform2, when, children }) {
        const context = (0, import_react13.useContext)(AdaptParentContext);
        let enabled = !platform2;
        if (platform2 === "touch")
          enabled = import_core22.isTouchable;
        if (platform2 === "native")
          enabled = !import_core22.isWeb;
        if (platform2 === "web")
          enabled = import_core22.isWeb;
...
var require_PresenceChild = __commonJS({
  "node_modules/@tamagui/animate-presence/dist/cjs/PresenceChild.js"(exports, module2) {
    ...
    var PresenceChild = /* @__PURE__ */ __name(({
      ...
      const presenceChildren = React12.useMemo(newChildrenMap, []);
      const id = (0, import_react13.useId)() || "";
...
var require_Dismissable = __commonJS({
  "node_modules/@tamagui/dismissable/dist/cjs/Dismissable.js"(exports, module2) {
    ...
    var DismissableContext = React12.createContext({
      layers: /* @__PURE__ */ new Set(),
      layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(),
      branches: /* @__PURE__ */ new Set()
    });
    var Dismissable2 = React12.forwardRef(
      (props, forwardedRef) => {
        const {
        ...
        const context = React12.useContext(DismissableContext);
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          "div",
          {
            ...
            onFocusCapture: (0, import_core22.composeEventHandlers)(
              // @ts-ignore
              props.onFocusCapture,
              focusOutside.onFocusCapture
            ),
            onBlurCapture: (0, import_core22.composeEventHandlers)(
              // @ts-ignore
              props.onBlurCapture,
              focusOutside.onBlurCapture
            ),
            onPointerDownCapture: (0, import_core22.composeEventHandlers)(
              // @ts-ignore
    ...
    var DismissableBranch = React12.forwardRef(
      (props, forwardedRef) => {
        const context = React12.useContext(DismissableContext);
...
var require_FocusScope = __commonJS({
  "node_modules/@tamagui/focus-scope/dist/cjs/FocusScope.js"(exports, module2) {
    ...
    var FocusScope2 = React12.forwardRef(
      (props, forwardedRef) => {
        const {
          loop = false,
          trapped = false,
  ...
  "node_modules/@tamagui/stacks/dist/cjs/getElevation.js"(exports, module2) {
    ...
    var getElevation2 = /* @__PURE__ */ __name((size3, extras) => {
      if (!size3)
        return;
      const { tokens } = extras;
      const token = tokens.size[size3];
      const sizeNum = (0, import_core22.isVariable)(token) ? +token.val : size3;
      return getSizedElevation2(sizeNum, extras);
    }, "getElevation");
    var getSizedElevation2 = /* @__PURE__ */ __name((val, { theme, tokens }) => {
      let num = 0;
      if (val === true) {
        const val2 = (0, import_core22.getVariableValue)(tokens.size["true"]);
...
var require_Stacks = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/Stacks.js"(exports, module2) {
    ...
    var YStack2 = (0, import_core22.styled)(import_core22.Stack, {
      flexDirection: "column",
      name: "YStack",
      variants: variants2
    });
    var XStack2 = (0, import_core22.styled)(import_core22.Stack, {
      flexDirection: "row",
      name: "XStack",
      variants: variants2
    });
    var ZStack2 = (0, import_core22.styled)(
      YStack2,
      {
        name: "ZStack",
        position: "relative"
...
var require_cjs10 = __commonJS({
  "node_modules/@tamagui/get-size/dist/cjs/index.js"(exports, module2) {
    ...
    module2.exports = __toCommonJS2(src_exports);
    var import_core22 = require("@tamagui/core-node");
    var getSize = /* @__PURE__ */ __name((size3, shift3 = 0, bounds = [0]) => {
      return stepTokenUpOrDown2("size", size3, shift3, bounds);
    }, "getSize");
    var stepTokenUpOrDown2 = /* @__PURE__ */ __name((type, name = "$true", shift3 = 0, bounds = [0]) => {
      const tokens = (0, import_core22.getTokens)({ prefixed: true })[type];
      const keysOrdered = import_core22.tokensKeysOrdered.get(tokens) || Object.keys(tokens);
      const min2 = bounds[0] ?? 0;
      const max2 = bounds[1] ?? keysOrdered.length - 1;
      const currentIndex = keysOrdered.indexOf(name);
      if (name === "$true") {
        shift3 += shift3 === 0 ? 0 : shift3 > 0 ? 1 : -1;
      }
      const index3 = Math.min(max2, Math.max(min2, currentIndex + shift3));
...
var require_variants = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/variants.js"(exports, module2) {
    ...
    var circular2 = {
      true: (_, { props, tokens }) => {
        const size3 = tokens.size[props.size];
        return {
          width: size3,
          height: size3,
          maxWidth: size3,
...
var require_SizableStack = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/SizableStack.js"(exports, module2) {
    ...
    var SizableStack2 = (0, import_core22.styled)(import_Stacks3.YStack, {
      name: "SizableStack",
...
var require_ThemeableStack = __commonJS({
  "node_modules/@tamagui/stacks/dist/cjs/ThemeableStack.js"(exports, module2) {
    ...
    var ThemeableStack2 = (0, import_core22.styled)(import_Stacks3.YStack, {
      name: "SizableStack",
      variants: {
        backgrounded: {
          true: {
    ...
    var Portal = /* @__PURE__ */ __name(({ host = ((_a) => (_a = globalThis.document) == null ? void 0 : _a.body)(), ...props }) => {
      const contents = /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        import_stacks8.YStack,
        {
          contain: "strict",
          fullscreen: true,
          position: import_core22.isWeb ? "fixed" : "absolute",
          maxWidth: import_core22.isWeb ? "100vw" : "100%",
          maxHeight: import_core22.isWeb ? "100vh" : "100%",
          pointerEvents: "none",
          ...props
        }
      );
      const [hostElement, setHostElement] = React12.useState(null);
      (0, import_core22.useIsomorphicLayoutEffect)(() => {
        setHostElement(host);
      }, [host]);
      if (hostElement) {
...
var require_GorhomPortal = __commonJS({
  "node_modules/@tamagui/portal/dist/cjs/GorhomPortal.js"(exports, module2) {
    ...
    var PortalHostComponent = /* @__PURE__ */ __name((props) => {
      ...
      const isServer2 = !(0, import_core22.useDidFinishSSR)();
    ...
    var PortalComponent = /* @__PURE__ */ __name((props) => {
      ...
      const handleOnMount = (0, import_core22.useEvent)(() => {
      ...
      const handleOnUnmount = (0, import_core22.useEvent)(() => {
      ...
      const handleOnUpdate = (0, import_core22.useEvent)(() => {
...
var require_useMergeRef = __commonJS({
  "node_modules/use-callback-ref/dist/es5/useMergeRef.js"(exports) {
    ...
    var React12 = tslib_1.__importStar(require("react"));
    var assignRef_1 = require_assignRef();
    var useRef_1 = require_useRef();
    var useIsomorphicLayoutEffect3 = typeof window !== "undefined" ? React12.useLayoutEffect : React12.useEffect;
  ...
  "node_modules/use-sidecar/dist/es5/hoc.js"(exports) {
    ...
    function sidecar(importer, errorComponent) {
      ...
      return /* @__PURE__ */ __name(function Sidecar(props) {
        ...
        return Car ? React12.createElement(Car, tslib_1.__assign({}, props)) : null;
      }, "Sidecar");
    }
  ...
  "node_modules/use-sidecar/dist/es5/renderProp.js"(exports) {
    ...
    function renderCar(WrappedComponent, defaults) {
      ...
      return /* @__PURE__ */ __name(function Combiner(props) {
        var defaultState = React12.useRef(defaults(props));
        var ref = React12.useRef(function(state) {
  ...
  "node_modules/react-remove-scroll/dist/es5/UI.js"(exports) {
    ...
    var RemoveScroll2 = React12.forwardRef(function(props, parentRef) {
      ...
      return React12.createElement(
        React12.Fragment,
        null,
        enabled && React12.createElement(SideCar, { sideCar: medium_1.effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
        forwardProps ? React12.cloneElement(React12.Children.only(children), tslib_1.__assign(tslib_1.__assign({}, containerProps), { ref: containerRef })) : React12.createElement(Container, tslib_1.__assign({}, containerProps, { className, ref: containerRef }), children)
      );
    });
...
var require_SideEffect = __commonJS({
  "node_modules/react-remove-scroll/dist/es5/SideEffect.js"(exports) {
    ...
    function RemoveScrollSideCar(props) {
      ...
      var Style = React12.useState(react_style_singleton_1.styleSingleton)[0];
      ...
      return React12.createElement(
        ...
        removeScrollBar ? React12.createElement(react_remove_scroll_bar_1.RemoveScrollBar, { gapMode: props.gapMode }) : null
      );
    }
...
var require_useKeyboardVisible = __commonJS({
  "node_modules/@tamagui/use-keyboard-visible/dist/cjs/useKeyboardVisible.js"(exports, module2) {
    ...
    var useKeyboardVisible2 = /* @__PURE__ */ __name(() => {
      const [isKeyboardVisible, setKeyboardVisible] = (0, import_react13.useState)(false);
      (0, import_react13.useEffect)(() => {
        const keyboardDidShowListener = import_react_native5.Keyboard.addListener("keyboardDidShow", () => {
...
var require_ScrollView = __commonJS({
  "node_modules/@tamagui/scroll-view/dist/cjs/ScrollView.js"(exports, module2) {
    ...
    var ScrollView = (0, import_web7.styled)(
    ...
    var SheetScrollView = (0, import_react13.forwardRef)(
      ({ __scopeSheet, children, ...props }, ref) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
          ...
          {
            ref: (0, import_core22.composeRefs)(scrollRef, ref),
            flex: 1,
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core22.Stack, { height: percentToPadBottom / 100 * frameSize, width: 0 })
            ]
          }
        );
      }
...
var require_Sheet = __commonJS({
  "node_modules/@tamagui/sheet/dist/cjs/Sheet.js"(exports, module2) {
    ...
    var SheetHandleFrame = (0, import_core22.styled)(import_stacks8.XStack, {
    ...
    var SheetOverlayFrame = (0, import_core22.styled)(import_stacks8.YStack, {
      ...
      ({ __scopeSheet, ...props }) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          SheetOverlayFrame,
          {
            ...
            ...props,
            onPress: (0, import_core22.mergeEvent)(
              props.onPress,
    ...
    var selectionStyleSheet = import_core22.isClient ? document.createElement("style") : null;
    if (selectionStyleSheet) {
      document.head.appendChild(selectionStyleSheet);
    }
    var SheetFrameFrame = (0, import_core22.styled)(import_stacks8.YStack, {
    ...
    var Sheet = (0, import_core22.withStaticProperties)(
      (0, import_react13.forwardRef)(/* @__PURE__ */ __name(function Sheet2(props, ref) {
        const hydrated = (0, import_core22.useDidFinishSSR)();
    ...
    var SheetImplementation = (0, import_core22.themeable)(
      (0, import_react13.forwardRef)(/* @__PURE__ */ __name(function SheetImplementation2(props, ref) {
        ...
        const driver = (0, import_core22.getAnimationDriver)();
        if (!driver) {
        ...
        const themeName = (0, import_core22.useThemeName)();
        ...
        const animateTo = (0, import_core22.useEvent)((position2) => {
        ...
        const shouldHideParentSheet = !import_core22.isWeb && modal && isShowingInnerSheet;
        ...
        const handleLayout = (0, import_react13.useCallback)((e) => {
          ...
          if (import_core22.isWeb && import_core22.isTouchable && !open) {
            next += 100;
          }
          if (!next)
            return;
        ...
        if (modal) {
          const modalContents = /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_portal3.Portal, { zIndex, ...portalProps, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core22.Theme, { forceClassName: true, name: themeName, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_adapt2.AdaptParentContext.Provider, { value: adaptContext, children: contents }) }) });
    ...
    var SheetController2 = /* @__PURE__ */ __name(({
      ...
      const onOpenChange = (0, import_core22.useEvent)(onOpenChangeProp);
...
var require_cjs20 = __commonJS({
  "node_modules/@tamagui/get-font-sized/dist/cjs/index.js"(exports, module2) {
    ...
    var getFontSized4 = /* @__PURE__ */ __name((sizeTokenIn = "$true", { fonts, props }) => {
      var _a, _b, _c;
      const family = (0, import_core22.getVariableValue)(props.fontFamily) || "$body";
    ...
    function getDefaultSizeToken(font) {
      ...
      const sizeTokens = "$true" in font.size ? font.size : (0, import_core22.getTokens)().size;
...
var require_Dialog = __commonJS({
  "node_modules/@tamagui/dialog/dist/cjs/Dialog.js"(exports, module2) {
    ...
    var DialogTriggerFrame2 = (0, import_core22.styled)(import_stacks8.YStack, {
      name: TRIGGER_NAME3
    });
    var DialogTrigger2 = React12.forwardRef(
      (props, forwardedRef) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          DialogTriggerFrame2,
          {
            ...
            onPress: (0, import_core22.composeEventHandlers)(props.onPress, context.onOpenToggle)
          }
        );
      }
    );
    ...
    var DialogPortalFrame2 = (0, import_core22.styled)(import_stacks8.YStack, {
      alignItems: "center",
    ...
    function DialogPortalItemContent2(props) {
      ...
      if (space || separator) {
        childrenSpaced = (0, import_core22.spacedChildren)({
          children,
          separator,
          space,
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(DialogProvider2, { scope: __scopeDialog, ...context, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core22.Theme, { name: themeName, children: childrenSpaced }) });
    }
    ...
    var DialogOverlayFrame2 = (0, import_core22.styled)(import_stacks8.ThemeableStack, {
      name: OVERLAY_NAME2,
      backgrounded: true,
      fullscreen: true
    });
    var DialogOverlay2 = React12.forwardRef(
    ...
    var DialogOverlayImpl2 = React12.forwardRef(
      (props, forwardedRef) => {
    ...
    var DialogContentFrame2 = (0, import_core22.styled)(import_stacks8.ThemeableStack, {
      name: CONTENT_NAME2,
      tag: "dialog",
      position: "relative",
      backgrounded: true,
    ...
    var DialogContentModal2 = React12.forwardRef(
      ({ children, context, ...props }, forwardedRef) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          DialogContentImpl2,
          {
            ...
            onCloseAutoFocus: (0, import_core22.composeEventHandlers)(props.onCloseAutoFocus, (event) => {
              var _a;
              event.preventDefault();
              (_a = context.triggerRef.current) == null ? void 0 : _a.focus();
            }),
            onPointerDownOutside: (0, import_core22.composeEventHandlers)(
            ...
            onFocusOutside: (0, import_core22.composeEventHandlers)(
    ...
    var DialogContentNonModal2 = React12.forwardRef(
      (props, forwardedRef) => {
    ...
    var DialogContentImpl2 = React12.forwardRef(
      (props, forwardedRef) => {
        const {
          __scopeDialog,
          trapFocus,
    ...
    var DialogTitleFrame2 = (0, import_core22.styled)(import_text5.H2, {
      name: TITLE_NAME2
    });
    var DialogTitle2 = React12.forwardRef(
      (props, forwardedRef) => {
    ...
    var DialogDescriptionFrame2 = (0, import_core22.styled)(import_text5.Paragraph, {
      name: "DialogDescription"
    });
    var DESCRIPTION_NAME2 = "DialogDescription";
    var DialogDescription2 = React12.forwardRef(
      (props, forwardedRef) => {
    ...
    var DialogClose2 = React12.forwardRef(
      (props, forwardedRef) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          import_stacks8.YStack,
          {
            ...
            ...closeProps,
            ref: forwardedRef,
            onPress: (0, import_core22.composeEventHandlers)(
              props.onPress,
...
For more information, see https://radix-ui.com/primitives/docs/components/${titleWarningContext.docsSlug}`;
    ...
    var Dialog3 = (0, import_core22.withStaticProperties)(
      React12.forwardRef(/* @__PURE__ */ __name(function Dialog22(props, ref) {
        const {
          __scopeDialog,
          children,
          open: openProp,
        ...
        const scopeId = (0, import_core22.useId)();
        const contentId = (0, import_core22.useId)();
        const titleId = (0, import_core22.useId)();
        const descriptionId = (0, import_core22.useId)();
    ...
    var useSheetBreakpointActive2 = /* @__PURE__ */ __name((context) => {
      const media = (0, import_core22.useMedia)();
...
var require_AlertDialog = __commonJS({
  "node_modules/@tamagui/alert-dialog/dist/cjs/AlertDialog.js"(exports, module2) {
    ...
    var NativeAlertDialogTriggerFrame = (0, import_core22.styled)(import_stacks8.YStack, {
      name: "DialogTrigger"
    });
      ...
      (props, forwardedRef) => {
        if (props["__native"]) {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            ...
            {
              ...rest,
              onPress: (0, import_core22.composeEventHandlers)(onPress, __onPress)
            }
          );
        }
          ...
          import_dialog.DialogWarningProvider,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(AlertDialogContentProvider, { scope: __scopeAlertDialog, cancelRef, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
              import_dialog.DialogContent,
              {
                ...
                ...contentProps,
                ref: composedRefs,
                onOpenAutoFocus: (0, import_core22.composeEventHandlers)(
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core22.Slottable, { children }),
      ...
      if (process.env.TAMAGUI_TARGET === "native") {
        ...
        forEachChildDeep(React12.Children.toArray(props.children), (child) => {
          if (!React12.isValidElement(child))
            return false;
          const name = (0, import_core22.isTamaguiElement)(child) ? child.type.staticConfig.componentName : child.type["displayName"];
          switch (name) {
            case TRIGGER_NAME3: {
    ...
    var AlertDialog = (0, import_core22.withStaticProperties)(AlertDialogInner, {
...
var require_Image = __commonJS({
  "node_modules/@tamagui/image/dist/cjs/Image.js"(exports, module2) {
    ...
    (0, import_core22.setupReactNative)({
      Image: import_react_native5.Image
    });
    var StyledImage = (0, import_core22.styled)(import_react_native5.Image, {
      name: "Image",
      position: "relative",
      source: { uri: "" },
      zIndex: 1
    ...
    var Image2 = StyledImage.extractable((inProps) => {
      const props = (0, import_core22.useMediaPropsActive)(inProps);
      const { src, ...rest } = props;
      const source = typeof src === "string" ? { uri: src, ...import_core22.isWeb && { width: props.width, height: props.height } } : src;
...
var require_getShapeSize = __commonJS({
  "node_modules/@tamagui/shapes/dist/cjs/getShapeSize.js"(exports, module2) {
    ...
    var getShapeSize2 = /* @__PURE__ */ __name((size3, { tokens }) => {
      const width = tokens.size[size3] ?? size3;
      const height = tokens.size[size3] ?? size3;
      return {
        width,
        height,
        minWidth: width,
...
var require_Square = __commonJS({
  "node_modules/@tamagui/shapes/dist/cjs/Square.js"(exports, module2) {
    ...
    var Square2 = (0, import_web7.styled)(import_stacks8.ThemeableStack, {
      name: "Square",
      alignItems: "center",
      justifyContent: "center",
      variants: {
...
var require_getFontSize = __commonJS({
  "node_modules/@tamagui/font-size/dist/cjs/getFontSize.js"(exports, module2) {
    ...
    var getFontSize2 = /* @__PURE__ */ __name((inSize, opts) => {
      ...
      if ((0, import_core22.isVariable)(res)) {
        return +res.val;
      }
      return res ? +res : 16;
    }, "getFontSize");
    var getFontSizeVariable = /* @__PURE__ */ __name((inSize, opts) => {
      ...
      const conf = (0, import_core22.getConfig)();
...
var require_getSpace = __commonJS({
  "node_modules/@tamagui/helpers-tamagui/dist/cjs/getSpace.js"(exports, module2) {
    ...
    var getSpace = /* @__PURE__ */ __name((token, sizeUpOrDownBy = 0) => {
      const spaces = (0, import_core22.getTokens)().space;
...
var require_useCurrentColor = __commonJS({
  "node_modules/@tamagui/helpers-tamagui/dist/cjs/useCurrentColor.js"(exports, module2) {
    ...
    var useCurrentColor = /* @__PURE__ */ __name((colorProp) => {
      const theme = (0, import_core22.useTheme)();
      return (0, import_core22.variableToString)(theme[colorProp] || colorProp || theme.color);
    }, "useCurrentColor");
  }
});
  ...
  "node_modules/zustand/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    if (process.env.NODE_ENV !== "production") {
      (function() {
        ...
        var useState6 = React12.useState, useEffect9 = React12.useEffect, useLayoutEffect4 = React12.useLayoutEffect, useDebugValue2 = React12.useDebugValue;
  ...
  "node_modules/zustand/node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    if (process.env.NODE_ENV !== "production") {
      (function() {
        ...
        var useRef8 = React12.useRef, useEffect9 = React12.useEffect, useMemo3 = React12.useMemo, useDebugValue2 = React12.useDebugValue;
...
var import_react7, import_with_selector, useDebugValue, useSyncExternalStoreWithSelector, didWarnAboutEqualityFn, identity, createImpl, create, react;
var init_esm = __esm({
  "node_modules/zustand/esm/index.js"() {
    init_vanilla();
    init_vanilla();
...
var require_dist3 = __commonJS({
  "node_modules/reforest/dist/index.js"(exports, module2) {
    ...
    var React12 = __toESM2(require("react"));
    var PrerenderContext = React12.createContext(false);
    PrerenderContext.displayName = "PrerenderContext";
    var MaxIndexContext = React12.createContext([]);
    MaxIndexContext.displayName = "MaxIndexContext";
    var IndexContext = React12.createContext(null);
    IndexContext.displayName = "IndexContext";
    var TreeStateContext = React12.createContext(null);
...
var require_Group = __commonJS({
  "node_modules/@tamagui/group/dist/cjs/Group.js"(exports, module2) {
    ...
    var GroupFrame = (0, import_core22.styled)(import_stacks8.ThemeableStack, {
      name: "GroupFrame",
      variants: {
        unstyled: {
          false: {
    ...
    function createGroup(verticalDefault) {
      return (0, import_core22.withStaticProperties)(
        (0, import_react13.forwardRef)((props, ref) => {
          ...
          const radius = borderRadius ?? (size3 ? (0, import_core22.getVariableValue)((0, import_core22.getTokens)().radius[size3]) - 1 : void 0);
    ...
    var GroupItem = /* @__PURE__ */ __name((props) => {
      ...
      const groupItemProps = useGroupItem(
        { disabled: (0, import_react13.isValidElement)(children) ? children.props.disabled : void 0 },
        __scopeGroup
      );
      if (!(0, import_react13.isValidElement)(children)) {
        return children;
      }
      if ((0, import_core22.isTamaguiElement)(children)) {
        return import_react13.default.cloneElement(children, groupItemProps);
      }
      return import_react13.default.cloneElement(children, {
        style: {
...
var require_ListItem = __commonJS({
  "node_modules/@tamagui/list-item/dist/cjs/ListItem.js"(exports, module2) {
    ...
    var import_react13 = require("react");
    var NAME3 = "ListItem";
    var ListItemFrame = (0, import_core22.styled)(import_stacks8.ThemeableStack, {
      name: NAME3,
      tag: "li",
      variants: {
        unstyled: {
    ...
    var ListItemText = (0, import_core22.styled)(import_text5.SizableText, {
      name: "ListItemText",
      variants: {
        unstyled: {
          false: {
    ...
    var ListItemSubtitle = (0, import_core22.styled)(ListItemText, {
    ...
    var ListItemTitle = (0, import_core22.styled)(ListItemText, {
      name: "ListItemTitle"
    });
    var useListItem = /* @__PURE__ */ __name((props, {
      ...
      const mediaActiveProps = (0, import_core22.useMediaPropsActive)(props);
      const size3 = mediaActiveProps.size || "$true";
      const subtitleSize = `$${+String(size3).replace("$", "") - 1}`;
      const iconSize = (0, import_font_size2.getFontSize)(size3) * scaleIcon;
      const getThemedIcon = (0, import_helpers_tamagui2.useGetThemedIcon)({ size: iconSize, color });
      const [themedIcon, themedIconAfter] = [icon, iconAfter].map(getThemedIcon);
      const spaceSize = (0, import_core22.getVariableValue)((0, import_core22.getTokens)().space[mediaActiveProps.space] ?? iconSize) * scaleSpace;
        ...
        props: {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
            themedIcon ? /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
              themedIcon,
              /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core22.Spacer, { size: spaceSize })
            ] }) : null,
            title || subTitle ? /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_stacks8.YStack, { flex: 1, children: [
              noTextWrap === "all" ? title : /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Title, { size: size3, children: title }),
    ...
    var ListItem = (0, import_core22.withStaticProperties)(
      ListItemFrame.extractable(
        (0, import_core22.themeable)(ListItemComponent, { componentName: NAME3 }),
...
var require_Popper = __commonJS({
  "node_modules/@tamagui/popper/dist/cjs/Popper.js"(exports, module2) {
    ...
    function Popper(props) {
      ...
      const anchorRef = React12.useRef();
      const [arrowEl, setArrow] = React12.useState(null);
      const [arrowSize, setArrowSize] = React12.useState(0);
      const arrowRef = React12.useRef();
      ...
      if (import_core22.isWeb) {
        ...
        const dimensions = (0, import_react_native5.useWindowDimensions)();
        const [keyboardOpen, setKeyboardOpen] = React12.useState(false);
        React12.useEffect(() => {
          const showSubscription = import_react_native5.Keyboard.addListener("keyboardDidShow", () => {
    ...
    var PopperAnchor = import_stacks8.YStack.extractable(
      React12.forwardRef(/* @__PURE__ */ __name(function PopperAnchor2(props, forwardedRef) {
    ...
    var PopperContentFrame = (0, import_core22.styled)(import_stacks8.ThemeableStack, {
      name: "PopperContent",
      variants: {
        unstyled: {
          false: {
    ...
    var PopperContent = React12.forwardRef(
      /* @__PURE__ */ __name(function PopperContent2(props, forwardedRef) {
        ...
        const { strategy, placement, floating, x, y, getFloatingProps, size: size3, isMounted } = usePopperContext(CONTENT_NAME2, __scopePopper);
        const contentRefs = (0, import_compose_refs3.useComposedRefs)(floating, forwardedRef);
        const contents = React12.useMemo(() => {
          return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            PopperContentFrame,
            {
    ...
    var PopperArrowFrame = (0, import_core22.styled)(import_stacks8.YStack, {
      name: "PopperArrow",
      variants: {
        unstyled: {
          false: {
    ...
    var PopperArrowOuterFrame = (0, import_core22.styled)(import_stacks8.YStack, {
    ...
    var PopperArrow = PopperArrowFrame.extractable(
      React12.forwardRef(/* @__PURE__ */ __name(function PopperArrow2(props, forwardedRef) {
        var _a, _b;
        const {
          __scopePopper,
          offset: offset22,
        ...
        const sizeValResolved = (0, import_core22.getVariableValue)((0, import_get_size2.stepTokenUpOrDown)("space", sizeVal, -2, [2]));
...
var require_Popover = __commonJS({
  "node_modules/@tamagui/popover/dist/cjs/Popover.js"(exports, module2) {
    ...
    var PopoverTrigger = React12.forwardRef((props, forwardedRef) => {
    ...
    function PopoverContentPortal(props) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_portal3.Portal, { zIndex, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_core22.Theme, { forceClassName: true, name: themeName, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core22.Stack, { zIndex: zIndex + 1, children: contents })
      ] }) });
    }
    __name(PopoverContentPortal, "PopoverContentPortal");
    var PopoverContentImpl = React12.forwardRef((props, forwardedRef) => {
      const {
        __scopePopover,
        trapFocus,
        onOpenAutoFocus,
      ...
      if (context.breakpointActive) {
        const childrenWithoutScrollView = React12.Children.toArray(children).map((child) => {
          if (React12.isValidElement(child)) {
            ...
            import_remove_scroll2.RemoveScroll,
            {
              ...
              children: trapFocus === false ? children : /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
                import_focus_scope2.FocusScope,
                {
                  ...
                  onMountAutoFocus: onOpenAutoFocus,
                  onUnmountAutoFocus: onCloseAutoFocus,
                  children: import_core22.isWeb ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { display: "contents" }, children }) : children
                }
              )
            }
          )
    ...
    var PopoverScrollView = React12.forwardRef((props, ref) => {
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_react_native5.ScrollView, { ref, ...props });
    });
    var Popover = (0, import_core22.withStaticProperties)(
      /* @__PURE__ */ __name(function Popover2(props) {
        ...
        const internalId = (0, import_core22.useId)();
        ...
        const popoverContext = {
          ...
          sheetBreakpoint,
          contentId: (0, import_core22.useId)(),
          triggerRef,
          open,
          breakpointActive,
          onOpenChange: setOpen,
          onOpenToggle: (0, import_core22.useEvent)(() => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(AdaptProvider, { children: import_core22.isWeb ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_floating.FloatingOverrideContext.Provider, { value: floatingContext, children: contents }) : contents });
      }, "Popover2"),
      {
...
var require_Progress = __commonJS({
  "node_modules/@tamagui/progress/dist/cjs/Progress.js"(exports, module2) {
    ...
    var ProgressIndicatorFrame = (0, import_core22.styled)(import_stacks8.ThemeableStack, {
      name: INDICATOR_NAME,
      height: "100%",
      width: "100%",
      backgrounded: true
...
Defaulting to \`null\`.`;
    ...
    var DEFAULT_MAX = 100;
    var ProgressFrame = (0, import_core22.styled)(import_stacks8.ThemeableStack, {
      name: PROGRESS_NAME,
      borderRadius: 1e5,
      overflow: "hidden",
      backgrounded: true,
      variants: {
        size: {
          "...size": (val) => {
            const size3 = Math.round((0, import_core22.getVariableValue)((0, import_get_size2.getSize)(val)) * 0.25);
            return {
              height: size3,
              minWidth: (0, import_core22.getVariableValue)(size3) * 20,
              width: "100%"
            };
          }
        }
    ...
    var Progress = (0, import_core22.withStaticProperties)(
      ProgressFrame.extractable(
        React12.forwardRef(
          (props, forwardedRef) => {
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(ProgressProvider, { scope: __scopeProgress, value, max: max2, width, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
              ProgressFrame,
              {
                size: size3,
                "aria-valuemax": max2,
    ...
    Progress.propTypes = {
      ...
      value(props, propName, componentName) {
        ...
        const max2 = isValidMaxNumber(props.max) ? props.max : DEFAULT_MAX;
...
var require_Label = __commonJS({
  "node_modules/@tamagui/label/dist/cjs/Label.js"(exports, module2) {
    ...
    var LabelComponent2 = React12.forwardRef(
      (props, forwardedRef) => {
        const { htmlFor, id: idProp, ...labelProps } = props;
        const controlRef = React12.useRef(null);
        const ref = React12.useRef(null);
        const composedRefs = (0, import_compose_refs3.useComposedRefs)(forwardedRef, ref);
...
var require_RadioGroup = __commonJS({
  "node_modules/@tamagui/radio-group/dist/cjs/RadioGroup.js"(exports, module2) {
    ...
    var RadioIndicatorFrame = (0, import_core22.styled)(import_stacks8.ThemeableStack, {
    ...
    var RadioGroupItemFrame = (0, import_core22.styled)(import_stacks8.ThemeableStack, {
        ...
        size: {
          "...size": (value, { props }) => {
            const size3 = Math.floor(
              (0, import_core22.getVariableValue)((0, import_get_size2.getSize)(value)) * (props["scaleSize"] ?? 0.5)
            );
            return {
              width: size3,
              height: size3
    ...
    var RadioGroupItem = RadioGroupItemFrame.extractable(
      React12.forwardRef(
        (props, forwardedRef) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(RadioGroupItemProvider, { checked, scope: __scopeRadioGroup, children: import_core22.isWeb && native ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            BubbleInput,
            {
              control: button,
    ...
    var RadioGroupFrame = (0, import_core22.styled)(import_stacks8.ThemeableStack, {
...
var require_SelectContent = __commonJS({
  "node_modules/@tamagui/select/dist/cjs/SelectContent.js"(exports, module2) {
    ...
    var SelectContent = /* @__PURE__ */ __name(({
      ...
      const contents = /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core22.Theme, { forceClassName: true, name: themeName, children });
      const touch = (0, import_core22.useIsTouchDevice)();
      if (showSheet) {
        if (!context.open) {
          return null;
        }
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_react13.FloatingPortal, { children: context.open ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_react13.FloatingOverlay, { style: { zIndex }, lockScroll: !touch, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_focus_scope2.FocusScope, { loop: true, trapped: true, ...focusScopeProps, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_dismissable2.Dismissable, { children: contents }) }) }) : /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { display: "none" }, children: contents }) });
    }, "SelectContent");
  }
});
...
var require_SelectImpl = __commonJS({
  "node_modules/@tamagui/select/dist/cjs/SelectImpl.js"(exports, module2) {
    ...
    var SelectInlineImpl = /* @__PURE__ */ __name((props) => {
      ...
      const [scrollTop, setScrollTop] = React12.useState(0);
      const touch = (0, import_core22.useIsTouchDevice)();
      const listItemsRef = React12.useRef([]);
      const overflowRef = React12.useRef(null);
      const upArrowRef = React12.useRef(null);
      const downArrowRef = React12.useRef(null);
      const allowSelectRef = React12.useRef(false);
      const allowMouseUpRef = React12.useRef(true);
      const selectTimeoutRef = React12.useRef();
      const state = React12.useRef({
        isMouseOutside: false
      });
      const [controlledScrolling, setControlledScrolling] = React12.useState(false);
      const [fallback, setFallback] = React12.useState(false);
      const [innerOffset, setInnerOffset] = React12.useState(0);
      const [blockSelection, setBlockSelection] = React12.useState(false);
      const floatingStyle = React12.useRef({});
      React12.useEffect(() => {
        const frame = requestAnimationFrame(() => {
          if (!open) {
            setScrollTop(0);
      ...
      if (import_core22.isWeb && import_core22.isClient) {
        React12.useEffect(() => {
          if (!open)
            return;
      ...
      const interactionsContext = React12.useMemo(() => {
        return {
          ...interactions,
          getReferenceProps() {
...
var require_SelectScrollButton = __commonJS({
  "node_modules/@tamagui/select/dist/cjs/SelectScrollButton.js"(exports, module2) {
    ...
    var SelectScrollButtonImpl = React12.memo(
      React12.forwardRef(
        (props, forwardedRef) => {
          var _a;
          ...
          const statusRef = React12.useRef("idle");
          const isVisible = context[dir === "down" ? "canScrollDown" : "canScrollUp"];
          const frameRef = React12.useRef();
...
var require_SelectViewport = __commonJS({
  "node_modules/@tamagui/select/dist/cjs/SelectViewport.js"(exports, module2) {
    ...
    var import_context = require_context();
    var import_useSelectBreakpointActive = require_useSelectBreakpointActive();
    var SelectViewportFrame = (0, import_core23.styled)(import_stacks8.ThemeableStack, {
    ...
    var SelectViewport = React12.forwardRef(
      (props, forwardedRef) => {
        ...
        if (breakpointActive || !import_core22.isWeb) {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_react13.FloatingFocusManager, { context: context.floatingContext, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            SelectViewportFrame,
            {
              size: context.size,
              role: "presentation",
...
var require_Select = __commonJS({
  "node_modules/@tamagui/select/dist/cjs/Select.js"(exports, module2) {
    ...
    var SelectValueFrame = (0, import_core22.styled)(import_text5.Paragraph, {
      name: VALUE_NAME,
      userSelect: "none"
    });
    ...
    var SelectIcon = (0, import_core22.styled)(import_stacks8.XStack, {
      name: "SelectIcon",
      // @ts-ignore
      "aria-hidden": true,
    ...
    var SelectItem = React12.forwardRef(
      (props, forwardedRef) => {
        ...
        const textId = (0, import_core22.useId)();
        const {
          selectedIndex,
          setSelectedIndex,
          listRef,
    ...
    var SelectItemTextFrame = (0, import_core22.styled)(import_text5.SizableText, {
      name: ITEM_TEXT_NAME,
      userSelect: "none"
    });
    ...
    var SelectItemIndicatorFrame = (0, import_core22.styled)(import_stacks8.XStack, {
      name: ITEM_TEXT_NAME
    });
    ...
    var SelectGroupFrame = (0, import_core22.styled)(import_stacks8.YStack, {
      name: GROUP_NAME,
      width: "100%"
    });
    var SelectGroup = React12.forwardRef(
      (props, forwardedRef) => {
        ...
        const groupId = (0, import_core22.useId)();
    ...
    var Select = (0, import_core22.withStaticProperties)(
      (props) => {
        ...
        const id = (0, import_core22.useId)();
        ...
        const SelectImpl = isSheet || !import_core22.isWeb ? SelectSheetImpl : import_SelectImpl.SelectInlineImpl;
        const forceUpdate = React12.useReducer(() => ({}), {})[1];
        ...
        const selectedIndexRef = React12.useRef(null);
        const activeIndexRef = React12.useRef(null);
        const listContentRef = React12.useRef([]);
        const [selectedIndex, setSelectedIndex] = React12.useState(0);
...
var require_SliderImpl = __commonJS({
  "node_modules/@tamagui/slider/dist/cjs/SliderImpl.js"(exports, module2) {
    ...
    var DirectionalYStack2 = (0, import_core22.styled)(import_stacks8.YStack, {
      variants: {
        orientation: {
          horizontal: {},
          vertical: {}
    ...
    var SliderFrame2 = (0, import_core22.styled)(DirectionalYStack2, {
      position: "relative",
      variants: {
        size: (val, extras) => {
          const orientation = extras.props.orientation;
          const size3 = Math.round((0, import_core22.getVariableValue)((0, import_get_size2.getSize)(val)) / 6);
      ...
      (props, forwardedRef) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
          SliderFrame2,
          {
            ...
            onResponderGrant: (0, import_core22.composeEventHandlers)(props.onResponderGrant, (event) => {
              const target = event.target;
              const isStartingOnThumb = context.thumbs.has(target);
              if (import_core22.isWeb && target instanceof HTMLElement) {
            ...
            onResponderMove: (0, import_core22.composeEventHandlers)(props.onResponderMove, (event) => {
              event.stopPropagation();
              onSlideMove(event);
            }),
            onResponderRelease: (0, import_core22.composeEventHandlers)(props.onResponderRelease, (event) => {
              onSlideEnd(event);
            })
          }
        );
...
var require_Slider = __commonJS({
  "node_modules/@tamagui/slider/dist/cjs/Slider.js"(exports, module2) {
    ...
    var SliderHorizontal = React12.forwardRef(
      (props, forwardedRef) => {
        const { min: min2, max: max2, dir, onSlideStart, onSlideMove, onStepKeyDown, ...sliderProps } = props;
        const direction = (0, import_use_direction.useDirection)(dir);
        const isDirectionLTR = direction === "ltr";
        const sliderRef = React12.useRef(null);
        const [state, setState] = React12.useState(() => ({ size: 0, offset: 0 }));
    ...
    var SliderVertical = React12.forwardRef(
      (props, forwardedRef) => {
        const { min: min2, max: max2, onSlideStart, onSlideMove, onStepKeyDown, ...sliderProps } = props;
        const [state, setState] = React12.useState(() => ({ size: 0, offset: 0 }));
        const sliderRef = React12.useRef(null);
        function getValueFromPointer(pointerPosition) {
          const input = [0, state.size];
    ...
    var SliderTrackFrame = (0, import_core22.styled)(import_SliderImpl.SliderFrame, {
      name: "SliderTrack",
      height: "100%",
      width: "100%",
      backgroundColor: "$background",
    ...
    var SliderTrackActiveFrame = (0, import_core22.styled)(import_SliderImpl.SliderFrame, {
      name: "SliderTrackActive",
      backgroundColor: "$background",
      position: "absolute"
    });
    var SliderTrackActive = React12.forwardRef(
      (props, forwardedRef) => {
    ...
    var getThumbSize = /* @__PURE__ */ __name((val) => {
      const size3 = typeof val === "number" ? val : (0, import_get_size2.getSize)(val, -1);
      return {
        width: size3,
        height: size3,
        minWidth: size3,
    ...
    var SliderThumbFrame = (0, import_core22.styled)(import_stacks8.ThemeableStack, {
      name: "SliderThumb",
      position: "absolute",
      bordered: 2,
      borderWidth: 2,
      backgrounded: true,
      pressTheme: import_core22.isWeb,
      focusTheme: import_core22.isWeb,
      hoverTheme: import_core22.isWeb,
      variants: {
        size: {
          "...size": getThumbSize
        }
    ...
    var SliderThumb = React12.forwardRef(
      (props, forwardedRef) => {
        ...
        const [size3, setSize] = React12.useState(() => {
          const estimatedSize = (0, import_core22.getVariableValue)(getThumbSize(sizeIn).width);
          return estimatedSize;
        });
        const thumbInBoundsOffset = size3 ? (0, import_helpers2.getThumbInBoundsOffset)(size3, percent, orientation.direction) : 0;
        React12.useEffect(() => {
          if (thumb) {
    ...
    var Slider = (0, import_core22.withStaticProperties)(
      React12.forwardRef((props, forwardedRef) => {
        const {
          name,
          min: min2 = 0,
          max: max2 = 100,
        ...
        function updateValues(value2, atIndex) {
          ...
          const nextValue = (0, import_helpers.clamp)(snapToStep, [min2, max2]);
...
var require_Switch = __commonJS({
  "node_modules/@tamagui/switch/dist/cjs/Switch.js"(exports, module2) {
    ...
    var getSwitchHeight = /* @__PURE__ */ __name((val) => Math.round((0, import_core22.getVariableValue)((0, import_get_size2.getSize)(val)) * 0.65), "getSwitchHeight");
    ...
    var SwitchThumbFrame = (0, import_core22.styled)(import_stacks8.ThemeableStack, {
      name: "SwitchThumb",
      variants: {
        unstyled: {
          false: {
        ...
        (props, forwardedRef) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            SwitchThumbFrame,
            {
              ...
              "data-disabled": disabled ? "" : void 0,
              ...thumbProps,
              x: checked ? (0, import_core22.getVariableValue)(getSwitchWidth(size3)) - (0, import_core22.getVariableValue)(getSwitchHeight(size3)) : 0,
              ref: forwardedRef
            }
          );
        }
    ...
    var SwitchFrame = (0, import_core22.styled)(import_stacks8.XStack, {
      name: SWITCH_NAME,
      tag: "button",
      variants: {
        unstyled: {
    ...
    var Switch = (0, import_core22.withStaticProperties)(
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(
              SwitchProvider,
              {
                ...
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
                    SwitchFrame,
                    {
                      ...
                      onPress: (event) => {
                        ...
                        if (import_core22.isWeb && isFormControl) {
                          hasConsumerStoppedPropagationRef.current = event.isPropagationStopped();
                          if (!hasConsumerStoppedPropagationRef.current)
                            event.stopPropagation();
                        }
                  ...
                  import_core22.isWeb && isFormControl && /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
                    BubbleInput,
                    {
                      control: button,
                      bubbles: !hasConsumerStoppedPropagationRef.current,
    ...
    function createCollection(name) {
      ...
      const CollectionSlot = import_react13.default.forwardRef(
        (props, forwardedRef) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core22.Slot, { ref: composedRefs, children });
        }
      );
      ...
      const CollectionItemSlot = import_react13.default.forwardRef(
        (props, forwardedRef) => {
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_core22.Slot, { ...{ [ITEM_DATA_ATTR]: "" }, ref: composedRefs, children });
        }
      );
...
var require_RovingFocusGroup = __commonJS({
  "node_modules/@tamagui/roving-focus/dist/cjs/RovingFocusGroup.js"(exports, module2) {
    ...
    var RovingFocusGroupImpl = React12.forwardRef((props, forwardedRef) => {
      ...
      const handleEntryFocus = (0, import_core22.useEvent)(onEntryFocus);
        ...
        RovingFocusProvider,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            import_core22.Stack,
            {
              ...
              onMouseDown: (0, import_core22.composeEventHandlers)(props.onMouseDown, () => {
                isClickFocusRef.current = true;
              }),
              onFocus: (0, import_core22.composeEventHandlers)(props.onFocus, (event) => {
              ...
              onBlur: (0, import_core22.composeEventHandlers)(props.onBlur, () => setIsTabbingBackOut(false))
            }
          )
        }
      );
    ...
    var RovingFocusGroupItem = React12.forwardRef((props, forwardedRef) => {
      const {
        __scopeRovingFocusGroup,
        focusable = true,
        active = false,
      ...
      const autoId = (0, import_core23.useId)();
        ...
        Collection.ItemSlot,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            import_core22.Stack,
            {
              ...
              ...itemProps,
              ref: forwardedRef,
              onMouseDown: (0, import_core22.composeEventHandlers)(props.onMouseDown, (event) => {
                if (!focusable)
                  event.preventDefault();
                else
                  context.onItemFocus(id);
              }),
              onFocus: (0, import_core22.composeEventHandlers)(props.onFocus, () => context.onItemFocus(id)),
              ...import_core22.isWeb && {
                onKeyDown: (0, import_core22.composeEventHandlers)(
                  props.onKeyDown,
                  (event) => {
    ...
    var RovingFocusGroup = (0, import_core22.withStaticProperties)(
      React12.forwardRef(
        (props, forwardedRef) => {
...
var require_Tabs = __commonJS({
  "node_modules/@tamagui/tabs/dist/cjs/Tabs.js"(exports, module2) {
    ...
    var TabsListFrame = (0, import_web7.styled)(import_group.Group, {
      name: TAB_LIST_NAME,
      focusable: true
      // defaultVariants: {
      //   flexGrow: 0,
    ...
    var TabsTriggerFrame = (0, import_web7.styled)(import_stacks8.ThemeableStack, {
      name: TRIGGER_NAME3,
      justifyContent: "center",
      alignItems: "center",
      flexWrap: "nowrap",
    ...
    var TabsTrigger = TabsTriggerFrame.extractable(
      React12.forwardRef(
        (props, forwardedRef) => {
          ...
          React12.useEffect(() => {
            if (!triggerRef.current || !import_web7.isWeb)
              return;
          ...
          return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_web7.Theme, { forceClassName: true, name: isSelected ? "active" : null, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            import_roving_focus.RovingFocusGroup.Item,
            {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
                TabsTriggerFrame,
                {
                  ...
                  onHoverIn: (0, import_web7.composeEventHandlers)(props.onHoverIn, () => {
                    if (layout) {
                      onInteraction == null ? void 0 : onInteraction("hover", layout);
                    }
                  }),
                  onHoverOut: (0, import_web7.composeEventHandlers)(props.onHoverOut, () => {
                  ...
                  size: context.size,
                  ...triggerProps,
                  ref: (0, import_web7.composeRefs)(forwardedRef, triggerRef),
                  onPress: (0, import_web7.composeEventHandlers)(props.onPress ?? void 0, (event) => {
                    const webChecks = !import_web7.isWeb || event.button === 0 && event.ctrlKey === false;
                  ...
                  ...import_web7.isWeb && {
                    type: "button",
                    onKeyDown: (0, import_web7.composeEventHandlers)(
                      props.onKeyDown,
                      (event) => {
                    ...
                    onFocus: (0, import_web7.composeEventHandlers)(props.onFocus, (event) => {
                      if (layout) {
                    ...
                    onBlur: (0, import_web7.composeEventHandlers)(props.onFocus, () => {
    ...
    var TabsContentFrame = (0, import_web7.styled)(import_stacks8.ThemeableStack, {
      name: CONTENT_NAME2
    });
    ...
    var TabsFrame = (0, import_web7.styled)(import_stacks8.SizableStack, {
      name: TABS_NAME
    });
    var Tabs = (0, import_web7.withStaticProperties)(
      React12.forwardRef(
        (props, forwardedRef) => {
          const {
            __scopeTabs,
...
var require_Tooltip = __commonJS({
  "node_modules/@tamagui/tooltip/dist/cjs/Tooltip.js"(exports, module2) {
    ...
    var TooltipArrow = React12.forwardRef((props, ref) => {
    ...
    var TooltipGroup = /* @__PURE__ */ __name(({ children, delay }) => {
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_react13.FloatingDelayGroup, { delay: React12.useMemo(() => delay, [JSON.stringify(delay)]), children });
    }, "TooltipGroup");
    var Tooltip = (0, import_core22.withStaticProperties)(
      (props) => {
        const {
          __scopePopover,
          children,
        ...
        const onOpenChange = (0, import_core22.useEvent)((open2) => {
          setOpen(open2);
          if (open2) {
            setCurrentId(id);
          }
        ...
        const useFloatingContext = React12.useCallback(useFloatingFn, [id, delay, open]);
        const onCustomAnchorAdd = React12.useCallback(() => setHasCustomAnchor(true), []);
        const onCustomAnchorRemove = React12.useCallback(() => setHasCustomAnchor(false), []);
        const contentId = (0, import_core22.useId)();
        const twoSmallerKey = (0, import_get_size2.stepTokenUpOrDown)("size", "$true", -2).key;
        const size3 = `$${twoSmallerKey}`;
        return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_floating.FloatingOverrideContext.Provider, { value: useFloatingContext, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_popper.Popper, { size: size3, ...popperScope, ...restProps, children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
...
var require_cjs50 = __commonJS({
  "node_modules/@tamagui/use-window-dimensions/dist/cjs/index.js"(exports, module2) {
    ...
    function useWindowDimensions() {
      const current = (0, import_react_native5.useWindowDimensions)();
...
var require_Checkbox = __commonJS({
  "node_modules/@tamagui/checkbox/dist/cjs/Checkbox.js"(exports, module2) {
    ...
    var CheckboxIndicatorFrame = (0, import_core22.styled)(import_stacks8.ThemeableStack, {
    ...
    var CheckboxIndicator = CheckboxIndicatorFrame.extractable(
      React12.forwardRef(
        (props, forwardedRef) => {
          ...
          const childrens = React12.Children.toArray(childrenProp);
          const children = childrens.map((child) => {
            if (disablePassStyles || !React12.isValidElement(child)) {
              return child;
            }
    ...
    var CheckboxFrame = (0, import_core22.styled)(import_stacks8.ThemeableStack, {
      name: CHECKBOX_NAME,
      tag: "button",
      variants: {
        unstyled: {
        ...
        size: {
          "...size": (val, { tokens }) => {
            const radiusToken = (0, import_core22.getVariableValue)((0, import_get_size2.getSize)(val)) / 8;
            return {
              borderRadius: radiusToken
            };
          }
    ...
    var Checkbox = (0, import_core22.withStaticProperties)(
      CheckboxFrame.extractable(
        React12.forwardRef(
          (props, forwardedRef) => {
            ...
            const [button, setButton] = React12.useState(null);
            const composedRefs = (0, import_core22.useComposedRefs)(forwardedRef, (node) => setButton(node));
            const hasConsumerStoppedPropagationRef = React12.useRef(false);
            const propsActive = (0, import_core22.useMediaPropsActive)(props);
            const isFormControl = import_core22.isWeb ? button ? Boolean(button.closest("form")) : true : false;
            const [checked = false, setChecked] = (0, import_use_controllable_state2.useControllableState)({
              prop: checkedProp,
            ...
            const adjustedSize = (0, import_core22.getVariableValue)(
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
              CheckboxProvider,
              {
                ...
                size: size3,
                scaleIcon,
                children: import_core22.isWeb && native ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
                  BubbleInput,
                  {
                    control: button,
                    bubbles: !hasConsumerStoppedPropagationRef.current,
...
var getElevation = /* @__PURE__ */ __name((size3, extras) => {
  ...
  const { tokens } = extras;
  const token = tokens.size[size3];
  const sizeNum = (0, import_core2.isVariable)(token) ? +token.val : size3;
    ...
    (props, forwardedRef) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        AvatarProvider,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AvatarFrame, { size: size3, ...avatarProps, ref: forwardedRef })
        }
      );
    }
  ),
...
// node_modules/tamagui/dist/esm/index.mjs
__reExport(esm_exports2, __toESM(require_cjs26(), 1), module.exports);
...
__reExport(esm_exports2, __toESM(require_cjs29(), 1), module.exports);
...
__reExport(esm_exports2, __toESM(require_cjs35(), 1), module.exports);
...
__reExport(esm_exports2, __toESM(require_cjs39(), 1), module.exports);
...
__reExport(esm_exports2, __toESM(require_cjs47(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs48(), 1), module.exports);
...
// node_modules/tamagui/dist/esm/index.mjs
__reExport(esm_exports2, __toESM(require_cjs50(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs51(), 1), module.exports);
__reExport(esm_exports2, __toESM(require_cjs52(), 1), module.exports);
...
var Spinner = YStack.extractable(
  (0, import_core19.themeable)(
    React11.forwardRef((props, ref) => {
      ...
      let color = colorProp;
      if (color && color[0] === "$") {
        color = (0, import_core19.variableToString)(theme[color]);
      }
      return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(YStack, { ref, ...stackProps, children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_react_native4.ActivityIndicator, { size: size3, color }) });
    }),
    {
